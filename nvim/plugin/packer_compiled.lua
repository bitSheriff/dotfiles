...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    after_files = { "/home/benjamin/.local/share/nvim/site/pack/packer/opt/Comment.nvim/after/plugin/Comment.lua" },
    config = { "\27LJ\2\2F\0\0\2\0\3\0\0066\0\0\0'\1\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\fcomment\27plugins.configs.others\frequire\0" },
    keys = { { "", "gc" }, { "", "gb" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/Comment.nvim",
  ...
  LuaSnip = {
    ...
    loaded = false,
    needs_bufread = true,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/LuaSnip",
  ...
  base46 = {
    ...
    loaded = true,
    only_config = true,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/start/base46",
  ...
  cmp_luasnip = {
    after = { "cmp-nvim-lua" },
    after_files = { "/home/benjamin/.local/share/nvim/site/pack/packer/opt/cmp_luasnip/after/plugin/cmp_luasnip.lua" },
    load_after = {
      LuaSnip = true
    },
    loaded = false,
    needs_bufread = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/cmp_luasnip",
  ...
  extensions = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/extensions",
  ...
  ["friendly-snippets"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/friendly-snippets",
  ...
  ["gitsigns.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/gitsigns.nvim",
  ...
  ["mason.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/mason.nvim",
  ...
  ["nvim-autopairs"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/nvim-autopairs",
  ...
  ["nvim-colorizer.lua"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/nvim-colorizer.lua",
  ...
  ["nvim-tree.lua"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/nvim-tree.lua",
  ...
  ["nvim-treesitter"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/nvim-treesitter",
  ...
  nvterm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/nvterm",
  ...
  ["plenary.nvim"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/plenary.nvim",
  ...
  ui = {
    ...
    loaded = true,
    needs_bufread = false,
    path = "/home/benjamin/.local/share/nvim/site/pack/packer/opt/ui",
