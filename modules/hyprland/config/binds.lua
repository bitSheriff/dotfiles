hl.define_submap("note", function()
    ...
    hl.bind("I", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ --class floating --title "Pop-up Terminal" -e ~/.local/bin/inbox]])) end)
    hl.bind("SHIFT + I", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ --class floating --title "Pop-up Terminal" -e ~/.local/bin/inbox -n]])) end)
    hl.bind("L", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ --class floating --title "Pop-up Terminal" -e ~/.local/bin/inbox -l]])) end)
    hl.bind("O", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd([[obsidian]])) end)
    hl.bind("D", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ nvim ~/notes/Journal/Entries/Daily/$(date +"%F").md]])) end)
    hl.bind("T", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ --class floating --title "Pop-up Terminal" -e ~/.local/bin/todo]])) end)
...
hl.define_submap("screen", function()
    hl.bind("a", hl.dsp.exec_cmd(apps.screenshot .. " -m region --freeze"))
    hl.bind("w", hl.dsp.exec_cmd(apps.screenshot .. " -m window --freeze"))
    hl.bind("m", hl.dsp.exec_cmd(apps.screenshot .. " -m output --freeze"))
    hl.bind("escape", hl.dsp.submap("reset"))
    hl.bind("Return", hl.dsp.submap("reset"))
    hl.bind("SUPER + R", hl.dsp.submap("reset"))
end)
...
hl.define_submap("files", function()
    hl.bind("D", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.file_manager .. [[ ~/Downloads/]])) end)
    hl.bind("M", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.file_manager .. [[ ~/Music/]])) end)
    hl.bind("V", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.file_manager .. [[ ~/Videos/]])) end)
    hl.bind("P", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.file_manager .. [[ ~/Pictures/]])) end)
    hl.bind("W", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.file_manager .. [[ ~/Documents/]])) end)
    hl.bind("C", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.file_manager .. [[ ~/code/]])) end)
    hl.bind("escape", hl.dsp.submap("reset"))
end)

hl.define_submap("code", function()
    hl.bind("D", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.code_editor .. [[ ~/code/dotfiles/]])) end)
    hl.bind("B", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.code_editor .. [[ ~/code/blog/]])) end)
    hl.bind("C", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.code_editor .. [[ ~/code/]])) end)
    hl.bind("SHIFT + D", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ -e nvim ~/code/dotfiles/]])) end)
    hl.bind("SHIFT + B", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ -e nvim ~/code/blog/]])) end)
    hl.bind("SHIFT + C", function() hl.dispatch(hl.dsp.submap("reset")); hl.dispatch(hl.dsp.exec_cmd(apps.terminal .. [[ -e nvim ~/code/]])) end)
    hl.bind("escape", hl.dsp.submap("reset"))
end)
...
hl.bind("SUPER + SHIFT + W", hl.dsp.exec_cmd("noctalia-shell ipc call wallpaper toggle"))
...
hl.bind("SUPER + SHIFT + B", hl.dsp.exec_cmd("qutebrowser")) -- deliberate alt browser
hl.bind("SUPER + Return", hl.dsp.exec_cmd(apps.terminal))
hl.bind("SUPER + E", hl.dsp.exec_cmd(apps.file_manager))
hl.bind("SUPER + SHIFT + E", hl.dsp.exec_cmd(apps.terminal .. " -e yazi $HOME"))
hl.bind("SUPER + O", hl.dsp.exec_cmd("obsidian"))
hl.bind("SUPER + C", hl.dsp.exec_cmd(apps.code_editor))
hl.bind("SUPER + SHIFT + C", hl.dsp.exec_cmd("speedcrunch"))
hl.bind("SUPER + ALT + C", hl.dsp.exec_cmd(apps.markdown_editor))
...
hl.bind("SUPER + CTRL + Z", hl.dsp.exec_cmd("marktext"))
hl.bind("SUPER + SHIFT + Z", hl.dsp.exec_cmd("zathura"))
hl.bind("SUPER + XF86AudioPlay", hl.dsp.exec_cmd("spotify-launcher"))
hl.bind("SUPER + SHIFT + XF86AudioPlay", hl.dsp.exec_cmd(apps.terminal .. " -e kew"))
