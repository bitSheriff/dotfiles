...
WOFI_SIZE_POS = "--location=top_right --width=450 --xoffset=-10"
...
# remove the trailing whitespaces at the end
output = output.strip()

# Call wofi and show the list. take the selected sink name and set it as the default sink
wofi_command = f"echo '{output}' | wofi {WOFI_OPTS} {WOFI_SIZE_POS} --lines={len(sinks)+1}"
